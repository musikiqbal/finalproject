...
if ($cek == 'y') {
	...
	if ($nilai_ipa > $nilai_ips) {
		$kata = "Rekomendasi Jurusan Terbaik : <br> Teknik Informatika / Teknik Kelautan / Teknik Metalurgi";
	} else if ($nilai_ipa < $nilai_ips) {
		$kata = "Rekomendasi Jurusan Terbaik : <br> Ilmu Politik / Sosiologi / Ilmu Komunikasi";
	} else {
		$kata = "Anda Dapat Memilih Antara Fakultas Teknik Atau Fakultas Ilmu Sosial";
	}
...
<div class="container">
	...
	<div class="col-sm-12" style="background-color:lightblue;font-size:15pt;text-align:center;">
		<?php echo $kata ?>
	</div>
			...
			<div class="panel-body">
				...
				<div class="panel panel-info">
					<div class="panel-body">
						<?php echo " " . $kata; ?><br />
						<ul>
							<li>Persentase Di Fakultas Teknik:<?php echo $persen_ipa . "%"; ?></li>
							<li>Persentase Di Fakultas Sosial:<?php echo $persen_ips . "%"; ?></li>
			...
			<div class="panel-body">
				...
				<script type="text/javascript">
					...
					var chart = new Chart(ctx, {
						...
						// The data for our dataset
						data: {
							labels: ["FAKULTAS TEKNIK", "FAKULTAS SOSIAL"],
							datasets: [{
								label: "Presentase",
