...
<div class="container">
	...
	<div class="col-sm-12" style="background-color:lightblue;font-size:20pt;text-align:center;">
		<?php echo $kata ?>
	</div>
...
<div class="container">
	<div class="col-sm-6">
		...
		<div class="panel panel-info">
			<div class="panel-body">
				Hasil prediksi untuk anda : <?php echo " " . $kata; ?><br />
				<ul>
					<li>Persentase Di FAKULTAS TEKNIK:<?php echo $persen_ipa . "%"; ?></li>
					<li>Persentase Di FAKULTAS ILMU SOSIAL:<?php echo $persen_ips . "%"; ?></li>
